				...
				<div class="tab_container">
				    <div id='tab1' class="tab_content pd0">
				        <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input style="width:500px;" name="title" id="param_name" _autocheck="true" type="text" value="{!! old('title',isset($new) ? $new['title'] : null ) !!}" />
								</span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input style="width:500px;" name="slug" id="param_name" _autocheck="true" type="text" value="{!! old('slug',isset($new) ? $new['slug'] : null ) !!}" />
								</span>
								<span name="name_autocheck" class="autocheck"></span>
								<div name="name_error" class="clear error">
									@if($errors->has('slug'))
						...
						<div class="formRow">
				            ...
				            <img src="{{ asset('resources/upload/'.$new['image']) }}" style="width: 200px; margin-left: 195px; height: 200px;" />
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="summary" id="param_sale" rows="10" cols="80">{!! old('summary',isset($new) ? $new['summary'] : null ) !!}</textarea></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="content" id="param_sale" rows="10" cols="80">{!! old('content',isset($new) ? $new['content'] : null ) !!}</textarea></span>
								<span name="sale_autocheck" class="autocheck"></span>
								<div name="name_error" class="clear error">
